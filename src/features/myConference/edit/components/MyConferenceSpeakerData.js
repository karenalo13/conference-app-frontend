...
const MyConferenceSpeakerData = props => {
  ...
  return (
    <Tr>
      ...
      <Td className={classes.tableContent}>
        <CustomTextField fullWidth value={nationality} onChange={onTextBoxChange(handleGeneralDispatch('nationality','nationality'))}></CustomTextField>
      </Td>
      <Td className={classes.tableContent}>
        <CustomTextField  value={rating} onChange={onTextBoxChange( handleDispatch('rating'))} fullWidth></CustomTextField>
      </Td>
      <Td className={classes.tableContent}>
